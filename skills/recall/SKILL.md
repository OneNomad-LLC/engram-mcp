...
1. Call `engram-search` with the user's query
...
6. If results seem stale or wrong, ask the user if they want to correct them (use `engram-outcome` with "corrected")
