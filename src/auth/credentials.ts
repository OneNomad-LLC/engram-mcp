...
function warn(msg: string): void {
  process.stderr.write(`przm-memory: credentials — ${msg}\n`);
}
...
function validate(parsed: unknown): Credentials | null {
 ...
 */
export function writeCredentials(creds: Credentials, path?: string): void {
  const file = credentialsPath(path);
